...
BEGIN_MESSAGE_MAP(CDlgDemoDlg, CDialogEx)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_GREEN, &CDlgDemoDlg::OnClickedGreen)
	ON_BN_CLICKED(IDC_RED, &CDlgDemoDlg::OnClickedRed)
	ON_BN_CLICKED(IDC_DARK, &CDlgDemoDlg::OnClickedDark)
	ON_BN_CLICKED(IDC_BLUE, &CDlgDemoDlg::OnClickedBlue)
	ON_COMMAND(IDC_LIGHT, &CDlgDemoDlg::OnLight)
END_MESSAGE_MAP()
...
void CDlgDemoDlg::OnClickedGreen()
{
	// TODO: Add your control notification handler code here
...
void CDlgDemoDlg::OnClickedBlue()
{
	// TODO: Add your control notification handler code here
...
void CDlgDemoDlg::OnClickedDark()
{
	// TODO: Add your control notification handler code here
